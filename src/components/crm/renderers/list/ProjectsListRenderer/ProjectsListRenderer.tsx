...
import css from './ProjectsListRenderer.module.css';
...
export const ProjectsListRenderer: FC<TBaseTableListRendererprops> = ({ pageData }) => {
        ...
        <Stack h="100%" justify="center" align="center">
          <Group justify="center" mt={20}>
            <NoData
              ...
              description="There are no projects defined yet"
      ...
      {!isEmpty( recordsData ) && (
        ...
        >
          ...
          <ScrollArea h={`${window.innerHeight - 340}px`}>
            <ProjectsList records={filteredData} entity={entity} />
